...
\thispagestyle{empty}
\hypertarget{g:colophon:idm533872380464}{}\vspace*{\stretch{2}}
...
%
\typeout{************************************************}
\typeout{Worksheet 0 Fraction Division Problems}
\typeout{************************************************}
%
\newgeometry{left=1.25cm, right=1.25cm, top=1.25cm, bottom=1.25cm}
...
%
\typeout{************************************************}
\typeout{Worksheet 0 Dividing Decimals}
\typeout{************************************************}
%
\newgeometry{left=1.25cm, right=1.25cm, top=1.25cm, bottom=1.25cm}
...
%
\typeout{************************************************}
\typeout{Worksheet 0 Exploring Numbers Through Rectangles}
\typeout{************************************************}
%
\newgeometry{left=1.25cm, right=1.25cm, top=1.25cm, bottom=1.25cm}
...
\end{tabular}
\par}
\captionof{table}{\label{g:table:idm533824106592}}
\end{sbspanel}%
\end{sidebyside}%
\end{introduction}%
\clearpage
...
%
\typeout{************************************************}
\typeout{Worksheet 0 GCF and LCM}
\typeout{************************************************}
%
\newgeometry{left=1.25cm, right=1.25cm, top=1.25cm, bottom=1.25cm}
...
%
\typeout{************************************************}
\typeout{Worksheet 0 Even and Odd Numbers}
\typeout{************************************************}
%
\newgeometry{left=1.25cm, right=1.25cm, top=1.25cm, bottom=1.25cm}
