...
##   [book-title]  
##                                              
## Copyright (C) 2019  [book-author]        
## See the file COPYING for copying conditions.  

## Generated from pretext-quickstart             
## https://github.com/oscarlevin/pretext-quickstart
...
html:
	...
	cp -a images $(HTMLOUT)
	cd $(HTMLOUT); \
	xsltproc --xinclude ../$(XSL)/custom-html.xsl ../$(MAIN);

html-fresh: diagrams html

viewhtml:
	$(HTMLVIEWER) $(HTMLOUT)/workbook.html &
...
latex:
	-rm $(PDFOUT)/workbook.tex
	install -d $(PDFOUT)
	cp -a images $(PDFOUT)
	cd $(PDFOUT); \
	xsltproc --xinclude ../$(XSL)/custom-latex.xsl ../$(MAIN) > workbook.tex;
